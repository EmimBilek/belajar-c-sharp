...
- __`WhenAll(params Task[] tasks)`__ -> kode yang dibawah method ini tidak akan dijalankan sebelum semua `Task` yang berada di dalam method `WhenAll()` telah selesai
